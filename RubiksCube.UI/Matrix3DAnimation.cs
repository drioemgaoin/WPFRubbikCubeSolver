...
namespace RubiksCube.UI
{
    public class Matrix3DAnimation : AnimationTimeline
    {
        ...
        public static DependencyProperty FromProperty = DependencyProperty.Register("From", typeof(Matrix3D?), typeof(Matrix3DAnimation), new PropertyMetadata(null));
        ...
        public static DependencyProperty ToProperty = DependencyProperty.Register("To", typeof(Matrix3D?), typeof(Matrix3DAnimation), new PropertyMetadata(null));
        ...
        public override object GetCurrentValue(object defaultOriginValue, object defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            var from = From ?? (Matrix3D)defaultOriginValue;
            var to = To ?? (Matrix3D)defaultDestinationValue;
